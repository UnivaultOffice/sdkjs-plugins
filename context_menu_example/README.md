...
This simple plugin is designed to show the basic functionality of UNIVAULTOFFICE Document Editor plugins. It shows how to add items into a context menu throught plugin.
